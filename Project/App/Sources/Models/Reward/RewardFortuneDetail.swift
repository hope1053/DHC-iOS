...
extension RewardFortuneDetail {
  static let sample = RewardFortuneDetail(
    title: "1년 운세",
    scoreInfo: .init(
      fortuneTitle: "2026년 운세 총평",
      scoreString: "99점",
      score: 99,
      summary: "마음이 들뜨는 날이에요, 한템포 쉬어가요."
    ),
    cardInfo: .init(
    ...
    categoryFortuneItems: [
      CategoryFortuneItem(
        imageURL: URL(string: "https://www.freepnglogos.com/uploads/apple-logo-png/apple-logo-png-dallas-shootings-don-add-are-speech-zones-used-4.png"),
        title: "금전운",
